    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginButton.setCallback(new Callback<TwitterSession>() {
            ...
            public void success(Result<TwitterSession> result) {
                ...
                Configurator.currentMirror.getConfigurator().getWidgetTwitter().setCurrentUserName(session.getUserName());

                //Active Widget Twitter
                Configurator.currentMirror.getConfigurator().getWidgetTwitter().setActive(true);
